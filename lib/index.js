...
exports.descriptionFromFuncStr = exports.PENDING_MODIFIERS = exports.ONLY_MODIFIERS = exports.DETERMINERS = exports.TEST_CONJUNCTIONS = exports.SETUP_CONJUNCTIONS = undefined;

var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();

var _descriptionFromFuncStr = require('./utils/description-from-func-str.js');

Object.defineProperty(exports, 'descriptionFromFuncStr', {
  enumerable: true,
  get: function get() {
    return _descriptionFromFuncStr.descriptionFromFuncStr;
  }
});
...
function bindMethod(name, method, chain, changes) {
  ...
  (0, _assign.assign)(newMethod, newChain);
  return newMethod;
};
...
function createParams(prefix, pending, only, params) {
  return (0, _assign.assign)({}, params, {
